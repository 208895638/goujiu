	...
	<view>
		...
		<div class=" bb">
				...
				<view  class="uni-list ">
					...
					<view class="uni-list-cell uni-list-cell-last" >
						<view class="uni-list-cell-navigate list">
							...
							<div class="right">
								<button class="mini-btn" type="warn" size="mini" @click="sendyzm" :disabled="!isDisabled">按钮</button>
							</div>
						</view>
					</view>
				</view>
			...
			<view class="uni-padding-wrap uni-common-mt btnList">
				 <button type="default" @click="isLogin" >下一步</button>
				...
				uni.request({
					...
					success: (res) => {
						...
						if(res.data.status == false){
							...
							uni.navigateTo({
								url: `/pages/page/setPassword/setPassword?id=${_this.user}&name=${_this.pass}`
							});
						}
